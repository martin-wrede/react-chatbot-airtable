...
// ../.wrangler/tmp/bundle-3iA94I/checked-fetch.js
...
async function onRequest(context) {
  ...
  try {
    ...
    const chatMessages = [
      {
        role: "system",
        content: "Du bist ein hilfsreicher AI-Assistent. Antworte h\xF6flich und informativ auf Deutsch."
      },
      ...messages.map((msg) => ({
        role: msg.role,
        content: msg.content
...
// ../.wrangler/tmp/pages-0e2CrK/functionsRoutes-0.7832342112666151.mjs
var routes = [
  {
    routePath: "/ai",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-3iA94I/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-3iA94I/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3634478255457585.mjs.map
