...
// ../.wrangler/tmp/bundle-hMF4AR/checked-fetch.js
...
async function onRequest2(context) {
  ...
  try {
    ...
    try {
      await saveToAirtable2(env, message, files);
      console.log("Successfully saved to Airtable");
    } catch (airtableError) {
      console.error("Airtable save failed:", airtableError);
    }
...
async function saveToAirtable2(env, originalMessage, files) {
  const AIRTABLE_API_KEY = env.AIRTABLE_API_KEY;
  const AIRTABLE_BASE_ID = env.AIRTABLE_BASE_ID;
  const AIRTABLE_TABLE_NAME = env.AIRTABLE_TABLE_NAME || "Prompts";
  if (!AIRTABLE_API_KEY || !AIRTABLE_BASE_ID) {
...
// ../.wrangler/tmp/pages-aBsUT2/functionsRoutes-0.34412397761216473.mjs
var routes = [
  {
    routePath: "/ai",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-hMF4AR/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-hMF4AR/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5962059012498537.mjs.map
